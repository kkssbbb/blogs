...
import com.kkssbbb.blogs.model.KakaoProfile;
import com.kkssbbb.blogs.model.OAuthToken;
...
public class UserController {
    ...
    public String kakaoCallback(String code) { //@ResponseBody 를 붙이면 Data를 리턴해주는 컨트롤러 함수가 된다.
